CREATE DATABASE  IF NOT EXISTS `shambala` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `shambala`;
...
CREATE TABLE `credit` (
  ...
  `OutgoingShipment_Id_FK` int(10) unsigned NOT NULL,
...
CREATE TABLE `custom_carat_price` (
  ...
  `OutgoinShipmentDetail_Id_FK` int(10) unsigned NOT NULL,
  KEY `OutgoingShipment_CustomPrice_Relationship_idx` (`OutgoinShipmentDetail_Id_FK`),
  CONSTRAINT `OutgoingShipment_CustomPrice_Relationship` FOREIGN KEY (`OutgoinShipmentDetail_Id_FK`) REFERENCES `outgoing_shipment_details` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `incoming_shipment` (
  ...
  CONSTRAINT `IncmingShipment_Flavour` FOREIGN KEY (`Flavour_Id_FK`) REFERENCES `flavour` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `outgoing_shipment_details` (
  ...
  `Flavour_Id_FK` tinyint(3) unsigned NOT NULL,
  `Total_Quantity_Returned` smallint(5) unsigned NOT NULL,
  `Scheme_Total_Quantity` tinyint(4) NOT NULL,
  `Scheme_Total_Price` decimal(6,2) NOT NULL,
  `Price_Per_Carat` decimal(6,2) DEFAULT NULL,
  `Total_Quantity_Taken` smallint(6) NOT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id_UNIQUE` (`Id`),
...
INSERT INTO `outgoing_shipment_details` VALUES (1,3,24,24,0,1,1,0,0,0.00,NULL,0),(2,3,30,60,2,2,1,0,0,0.00,NULL,0),(51,1,24,9,0,6,2,0,0,0.00,NULL,0),(177,1,24,6,0,3,3,0,0,0.00,NULL,0),(264,1,24,240,0,10,3,0,0,0.00,NULL,0),(367,1,24,27,0,12,1,0,0,0.00,NULL,0),(379,2,24,720,0,11,3,0,0,0.00,NULL,0),(391,1,24,240,0,8,1,0,0,0.00,NULL,0),(448,3,24,24,0,13,1,0,0,0.00,NULL,0),(712,1,24,240,0,9,2,0,0,0.00,NULL,0),(877,1,24,12,0,13,1,0,0,0.00,NULL,0),(883,1,24,1,0,13,2,0,0,0.00,NULL,0);
...
CREATE TABLE `product` (
  ...
  `SchemeQuantity` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Id_UNIQUE` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-08-31 14:23:33
